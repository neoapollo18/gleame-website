        ...
        <div className="container">
          <div className="grid lg:grid-cols-[180px_1fr] gap-12 lg:gap-16 max-w-5xl mx-auto">
            ...
            <article className="max-w-none">
              ...
              {/* Challenge */}
              <div id="challenge" className="mb-14">
                <h2 className="text-2xl font-semibold text-gray-900 mb-4 tracking-tight">
                  Challenge
                </h2>
                <div className="space-y-4 text-gray-500 font-light leading-relaxed text-[16px]">
                  ...
                  <p>
                    ...
                    product worked, but they couldn&apos;t trust it would work for{" "}
                    <em>their</em> face.
                  </p>
                </div>
              </div>
              ...
              {/* Solution */}
              <div id="solution" className="mb-14">
                <h2 className="text-2xl font-semibold text-gray-900 mb-4 tracking-tight">
                  Solution
                </h2>
                <div className="space-y-4 text-gray-500 font-light leading-relaxed text-[16px]">
                  ...
                  <div className="flex gap-8 items-start">
                    ...
                    <div className="hidden md:block flex-shrink-0 w-[200px] rounded-xl overflow-hidden shadow-lg ring-1 ring-gray-900/5">
                      <Image
              ...
              <div id="results" className="mb-14">
                ...
                <p className="text-gray-500 font-light leading-relaxed text-[16px] mb-8">
                  Over a 10-day controlled test (8,343 visitors, 364 orders),
                  Gleame delivered a 13.22% lift in conversion rate and a 9.17%
                  lift in revenue per visitor. These improvements were validated
                  using Intelligems and project meaningful monthly incremental
                  revenue for MenPen.
                </p>

                <div className="max-w-md rounded-xl overflow-hidden shadow-lg ring-1 ring-gray-900/5">
                  <Image
              ...
              {/* Quote */}
              <div className="mb-14 border-l-4 border-primary pl-6 py-2">
                <blockquote className="text-lg text-gray-700 italic font-light leading-relaxed mb-3">
                  &ldquo;Gleame was a game-changer for us. It let shoppers see the
                  product on themselves before buying &mdash; and conversion jumped
                  almost overnight.&rdquo;
                </blockquote>
              ...
              {/* Takeaways */}
              <div id="takeaways" className="mb-14">
                <h2 className="text-2xl font-semibold text-gray-900 mb-4 tracking-tight">
                  Takeaways
                </h2>
                <div className="space-y-4 text-gray-500 font-light leading-relaxed text-[16px]">
                  ...
                  <p>
                    That &ldquo;Oh &mdash; this actually looks good on me&rdquo; moment was
                    the unlock. With hesitation removed, Gleame helped unlock a
                    13% conversion lift validated by testing, RPV increased, and
                    MenPen generated hundreds of incremental orders each month
              ...
              {/* CTA */}
              <div className="bg-gray-50 border border-gray-200 rounded-2xl p-8 lg:p-10 text-center">
